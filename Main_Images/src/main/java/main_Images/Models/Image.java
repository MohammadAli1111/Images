...
public class Image {
    ...
    public Image(String name, byte[] data_image, String imagecategory, int userid) {
        this.name = name;
        this.data_image = data_image;
    ...
    public Image(int id, String name, byte[] data_image, String imagecategory, int mylike, int unlike, int userid) {
        this.id = id;
        this.name = name;
        this.data_image = data_image;
        this.imagecategory = imagecategory;
